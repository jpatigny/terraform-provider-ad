...
func (g *GPLink) NewGPLink(client *winrm.Client, local bool) (string, error) {
...
func (g *GPLink) ModifyGPLink(client *winrm.Client, changes map[string]interface{}, local bool) error {
	...
	result, err := RunWinRMCommand(client, cmds, false, false, local)
	if err != nil {
...
func (g *GPLink) RemoveGPLink(client *winrm.Client, local bool) error {
...
//Domain Controller
func GetGPLinkFromHost(client *winrm.Client, gpoGUID, containerGUID string, local bool) (*GPLink, error) {
